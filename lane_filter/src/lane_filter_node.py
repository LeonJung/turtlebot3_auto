...
from turtlebot3_auto_msgs.msg import SegmentList, Segment, Pixel, LanePose, BoolStamped, Twist2DStamped
...
For more info on algorithm and parameters please refer to the google doc:
 https://drive.google.com/open?id=0B49dGT7ubfmSX1k5ZVN1dEU4M2M
    ...
    def __init__(self):
        ...
        self.sub = rospy.Subscriber("ground_projection/lineseglist_out", SegmentList, self.processSegments, queue_size=1)
    ...
    def processSegments(self,segment_list_msg):
        ...
        for segment in segment_list_msg.segments:
            ...
            rospy.loginfo('progress 3 stopped here')
