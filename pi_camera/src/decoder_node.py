...
from turtlebot3_auto_msgs.msg import BoolStamped
import time
...
class DecoderNode(object):
    def __init__(self):
        ...
        self.pub_raw = rospy.Publisher("cali_image",Image,queue_size=1)
        self.last_stamp = rospy.Time.now()
        self.sub_compressed_img = rospy.Subscriber("image_raw/compressed",CompressedImage,self.cbImg,queue_size=1)
    ...
    def cbImg(self,msg):
        ...
        cv_image = cv2.imdecode(np_arr, 1) # since cv2.CV_LOAD_IMAGE_COLOR = 1 doesn't work anymore automatically
        # time_1 = time.time()
