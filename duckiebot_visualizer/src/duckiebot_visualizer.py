...
from turtlebot3_auto_msgs.msg import Segment, SegmentList
...
class DuckieBotVisualizer(object):
    def __init__(self):
        ...
        # Setup subscriber
        self.sub_seg_list = rospy.Subscriber("ground_projection/lineseglist_out", SegmentList, self.cbSegList)
