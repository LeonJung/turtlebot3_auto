...
from turtlebot3_auto_msgs.msg import AntiInstagramHealth, BoolStamped, AntiInstagramTransform
...
from anti_instagram.timekeeper import TimeKeeper
...
class AntiInstagramNode():
	def __init__(self):
		...
		self.sub_image = rospy.Subscriber("image_raw/compressed", CompressedImage, self.cbNewImage,queue_size=1)
		self.sub_click = rospy.Subscriber("click", Bool, self.cbClick, queue_size=1)
